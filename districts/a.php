...
<body1
  <section class="corona_update container-fluid">
	<div class="my-5 ml-5">
		<h3 class="text-center text-uppercase " align="center">Andaman and Nicobar 0 corona updates</h3>
	</div>
			...
			<th class="text-capitalize"style="border:2px solid #ddd;padding: 15px; background-color: dodgerblue; color: white">Deceased</th>
                      ...
                      <?php
                       ...
                       $coronalive=json_decode($data,true); 
                        ...
                        $districtscount=count($coronalive[1]['districtData']);
                        $i=1;
                        while($i < $districtscount){
                         ...
                         <tr >
	                         ...
	                         <td style="border:2px solid #ddd;padding: 15px;" ><?php echo $coronalive[1]['districtData'][$i]['district'] ?></td>
	                          <td style="border:2px solid #ddd;padding: 15px;"><?php echo $coronalive[1]['districtData'][$i]['active'] ?></td>
	                      <td style="border:2px solid #ddd;padding: 15px;"><?php echo $coronalive[1]['districtData'][$i]['confirmed'] ?></td>
	                       <td style="border:2px solid #ddd;padding: 15px;"><?php echo $coronalive[1]['districtData'][$i]['recovered'] ?></td>
	                       <td style="border:2px solid #ddd;padding: 15px;"><?php echo $coronalive[1]['districtData'][$i]['deceased'] ?></td>
                           </tr>
